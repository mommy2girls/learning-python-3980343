...
# Dictionary: a key-value data structure, keys must be unique
mydict = {
  "one" : 1,
  "two" : 2,
  3 : "three",
...
# print(mydict["blarg"]) KeyError: 'blarg'

# To avoid this, you can use the "in" operator to see if a key exists
# print("two" in mydict)  True
# print("blarg" in mydict)  False

# You can retrieve all of the keys and values from a dictionary
# print(mydict.keys()) -> dict_keys(['one', 'two', 3, 4.5, 'seven'])
# print(mydict.values()) -> dict_values([1, 2, 'three', ['four', 'point', 'five'], 7])
